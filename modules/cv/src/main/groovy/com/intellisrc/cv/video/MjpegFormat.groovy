...
@CompileStatic
class MjpegFormat extends JpegFormat {
	/**
	 ...
	 * This header is optional and depends on the API call used with the camera.
	 */
	static final String DELTA_TIME = "Delta-time"

	/**
	 * Typical max length of header data.
	 */
	static int HEADER_MAX_LENGTH = 100
	 ...
	 */
	static int parseContentLength(byte[] headerBytes)
		throws IOException, NumberFormatException {
		return parseContentLengthPrivate(new ByteArrayInputStream(headerBytes))
	}

	private static int parseContentLengthPrivate(ByteArrayInputStream headerIn)
		throws IOException, NumberFormatException {

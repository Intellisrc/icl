...
class LpCode {
    ...
    // Unified Canadian Aborigine Syllabics (710 chars)
    ...
    // (153 chars)
    static public final List<Integer> MONGOLIAN = (0x1800..0x18AA) - (0x180B..0x180F) - (0x181A..0x181F) - (0x1879..0x187F) // SMP: + (0x11660..0x1166C)
    // (68 chars)
    static public final List<Integer> LIMBU = (0x1900..0x194F) - [0x191F] - (0x192C..0x192F) - (0x193C..0x193F) - (0x1941..0x1943)
    // Taile / new Taile (118 chars)
    ...
    // Chinese (inc. Japanese Kanji, 27,558 chars)
    ...
    // (88 chars)
    static public final List<Integer> BAMUM = (0xA6A0..0xA6F7) //SMP: + (0x16800..0x16A39)
    // (45 chars)
    ...
    // SMP: Supplementary Multilingual Plane (TODO)
    /*
    // ( chars)
    ...
    static public final List<Integer> IDIOGRAMS = (0x10000..0x1005D) - [0x1000C,0x10027,0x1003B,0x1003E,0x1004E,0x1004F] +
                                                  (0x10080..0x100FA)
    // ( chars)
    static public final List<Integer> BLOCK_EXT = (0x1FB00..0x1FBCA)
    // (10 chars)
    ...
    // Superscript (14 chars)
    static public final List<Integer> SUPERSCRIPT = [0x2070,0x2071] + (0x2074..0x207F)
    // (29 chars)
    static public final List<Integer> SUBSCRIPT = (0x2080..0x209C)
    // (32 chars)
    ...
    static public final List<Integer> SYMBOLS = (0x2010..0x2027) + [0x203E,0x2043,0x20DB,0x20DC,0x20E6,0x20E8]  + (0x2030..0x205E) +
                                                ...
                                                (0xFFF9..0xFFFD) //SMP: + (0x10600..0x10736) + (0x10740..0x10755) + (0x10760..0x10767)
    ...
    // Lines (64 chars)
    static public final List<Integer> LINES = (0x4DC0..0x4DFF)
    ...
    // South-East Asia (673 chars)
    static public final List<Integer> SE_ASIA = MALAYAM + SINHALA + THAI + LAO + MYANMAR + TAI_VIET
    ...
    static public final List<Integer> VISIBLE = ASCII + GREEK + CYRILLIC + ARMENIAN + HEBREW + ARABIC + SYRIAC + THAANA +
        NKO + SAMARITAN + MANDAIC + INDIAN + SE_ASIA + TIBETAN + CJK + BRAILLE + SYMBOLS + LINES - SPACE
    ...
    static void printLengths() {
        charsets.each {
            println it.key + " : " + it.value.length
        }
    }
}
